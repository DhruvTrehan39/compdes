    ...
    void print_nfa_table(int nfa_table[][col],int states){
        ...
        for(int i=0;i<60;i++)
            cout<<"*";
            cout<<endl<<endl;
        cout<<setw(43)<<"TRANSITION TABLE FOR NFA OF THE GIVEN REGEX"<<endl<<endl;
    ...
    void print_dfa_table(string dfa_tab[][3],int state){
        ...
        for(int i=0;i<60;i++)
            cout<<"*";
        cout<<endl<<endl;
        cout<<setw(43)<<"TRANSITION TABLE FOR DFA OF THE GIVEN REGEX"<<endl<<endl;
    ...
    void simulator(string dfa_tab[][3],string word,int state){
        ...
        for(i=0;i<len;i++){
            if(temp == "--"){
                cout<<endl<<"Given string does not belong to given regular expression."<<endl<<endl;
                break;
            } else {
                int _xtate;
                int j=0;
        ...
        if(i == len){
            ...
            for(j=0;j<_b;j++){
                if(temp == fin_dfa[j]){
                    cout<<endl<<"Given string belongs to given regular expression."<<endl<<endl;
                    break;
                }
            }
            if(j==_b){
                cout<<endl<<"Given string does not belongs to given regular expression."<<endl<<endl;
            }
        }
    ...
    int main(){
        ...
        int states=0;
        cout<<"Input a regular expression :-  "<<endl;
        string s;
        cin>>s;
        ...
        while(true){
            ...
            string word;
            cout<<"Input a string to check whether it belongs to given regular expression or not."<<endl
                <<"OR press 1 to exit."<<endl;
